...
import { processJobTitle, getTimestamp } from "@/lib/utils";
        ...
        <div className="flex-between mt-8 flex-wrap gap-6">
          <div className="flex flex-wrap items-center gap-6">
            <div className="flex items-center gap-2">
              ...
              <p className="body-medium text-light-500">Posted {getTimestamp(new Date(job_posted_at_datetime_utc as string))}</p>
